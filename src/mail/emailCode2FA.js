...
export function setCodigo2FA(codigo) {
  codigoUnico = codigo;
...
<body>
  <div class="container">
    ...
    <h1>¿Fuiste tú?</h1>
    <p>¡Hola!</p>
    <p>Se ha detectado un inició se sesión sospechoso, confirma que eres tú ingresando el siguiente código:</p>
    <div class="code-container">
      <h2>${codigoUnico}</h2>
    </div>
    <p>Este código es válido por un solo uso.</p>
    <p>Si no fuiste tu te recomendamos cambiar tu contraseña</p>
